				...
				<div className='h-full px-3 py-4 overflow-y-auto bg-[#002350] text-gray-200'>
					...
					<ul className='space-y-2 font-medium'>
						...
						<li>
							...
							>
								<svg
									className='w-5 h-5 text-gray-300 transition duration-75 group-hover:text-gray-200'
									aria-hidden='true'
									xmlns='http://www.w3.org/2000/svg'
									fill='currentColor'
									viewBox='0 0 22 21'
								...
								<span className='ms-3'>Intro</span>
							</Link>
						</li>
						...
						<li>
							...
							<ul id='dropdown-example' className='py-2 space-y-2'>
								<li>
									<Link
										href='/vanilla'
										className='flex items-center w-full p-2 text-gray-200 transition duration-75 rounded-lg pl-11 group hover:bg-gray-700'
									>
										Vanila Prices
									</Link>
								</li>
